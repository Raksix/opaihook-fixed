...
public:
	...
	int GetHitboxSet()
	{
		return *reinterpret_cast<int*>((DWORD)this + 0x9FC);
	}
	Vector GetAngRotation()
	{
		return *reinterpret_cast<Vector*>((DWORD)this + 0x12C);
	}
	...
	float Friction()
	{
		return *reinterpret_cast<float*>((DWORD)this + 0x144);
	}
	int GetTeamNum()
	{
	...
	Vector Velocity()
	{
		return *reinterpret_cast<Vector*>((DWORD)this + 0x114);
	}
	...
	{
		return *reinterpret_cast<std::array<float, 24>*>(reinterpret_cast<uintptr_t>(this) + 0x2980);
	}
	...
	{
		return *reinterpret_cast<Vector*>((DWORD)this + 0x108);
	}
	...
	bool EntityISPlayer()
	{
		...
		return CallVFunction<OriginalFn>(this, 153)(this);
	}
	Vector GetVelocity()
	{
	...
	float MaxSpeed()
	{
		return *reinterpret_cast<float*>((DWORD)this + 0x3248);
	}
	...
	bool IsBroken()
	{
		return *reinterpret_cast<bool*>((DWORD)this + 0xA04);
	}
	CollisionProperty* GetCollision()
	{
		return reinterpret_cast<CollisionProperty*>((DWORD)this + 0x031C);
	}
	...
	{
		return *reinterpret_cast<QAngle*>((DWORD)this + 0x302C);
	}
	QAngle GetPunchAngleVelocity()
	{
		return *reinterpret_cast<QAngle*>((DWORD)this + 0x3038);
	}
	...
	int GetGlowIndex()
	{
		return *reinterpret_cast<int*>((DWORD)this + 0xA3F8);
	}
	UINT* GetWeapons()
	{
		return (UINT*)((DWORD)this + 0x2EF8);
	}
	std::vector< CBaseCombatWeapon* > CBaseEntity::GetWeaponsData();
	int GetMoveType()
	{
		return *reinterpret_cast<int*>((DWORD)this + 0x25C);
	}
	...
	int GetMoney()
	{
		return *reinterpret_cast<int*>((DWORD)this + 0xB314);
	}
