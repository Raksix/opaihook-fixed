...
public:
	...
	{
		return *reinterpret_cast<float*>((DWORD)this + 0x321C);
	}
	...
	int GetZoomLevel()
	{
		return *reinterpret_cast<int*>((DWORD)this + 0x3390);
	}
	...
	float GetFloatRecoilIndex()
	{
		if (!this)
			return -1.f;
		return *reinterpret_cast<float*>((DWORD)this + 0x3314);
	}
	...
	float GetCone()
	{
		if (!this)
			return -1.f;
		typedef float(__thiscall* OriginalFn)(void*);
		return CallVFunction<OriginalFn>(this, 471)(this);
