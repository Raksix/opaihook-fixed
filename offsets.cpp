...
void SetupOffsets()
{
	...
	offys.dwInitKeyValues = FindPatternIDA(XorStr(client_dll), XorStr("55 8B EC 51 33 C0 C7 45"));
...
//	offys.m_hObserverTarget = g_pNetVars->GetOffset(XorStr("DT_BasePlayer"), XorStr("m_hObserverTarget"));
	...
	offys.getSequenceActivity = (DWORD)FindPatternIDA(client_dll, "55 8B EC 53 8B 5D 08 56 8B F1 83");
	...
	static uintptr_t player_resource_pointer = uintptr_t((uintptr_t)GetModuleHandle(client_dll) + 0x3112F5C);
